...
import { FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaPhone, FaEnvelope, FaMapMarkerAlt, FaHeart, FaHeartbeat } from 'react-icons/fa';
...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: FaFacebookF, href: '#', label: 'Facebook', gradient: 'from-[#339967] to-[#1495d9]' },
    { icon: FaTwitter, href: '#', label: 'Twitter', gradient: 'from-[#1495d9] to-[#339967]' },
    { icon: FaInstagram, href: '#', label: 'Instagram', gradient: 'from-[#339967] to-[#1495d9]' },
    { icon: FaLinkedinIn, href: '#', label: 'LinkedIn', gradient: 'from-[#1495d9] to-[#339967]' },
  ];
        ...
        <div className="py-12 sm:py-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              >
                <div className="relative w-14 h-14 rounded-full bg-gradient-to-br from-[#339967] to-[#1495d9] p-1 shadow-xl" style={{ boxShadow: '0 10px 30px rgba(51, 153, 103, 0.3)' }}>
              ...
              <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
                Providing compassionate, professional home care services to families across Calgary and surrounding areas since 2013.
              </p>
              ...
              >
                ...
                <span className="text-sm font-semibold text-[#339967]">Licensed & Certified</span>
              </motion.div>
            </div>
            ...
            >
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#339967] to-[#1495d9] flex items-center justify-center group-hover:scale-110 transition-transform">
                  <FaPhone className="text-sm" />
                </div>
                <span className="text-xs sm:text-sm">+1 (403) 555-1234</span>
              </a>
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#1495d9] to-[#339967] flex items-center justify-center group-hover:scale-110 transition-transform">
                  <FaEnvelope className="text-sm" />
                </div>
                <span className="text-xs sm:text-sm break-all">info@comforthomecare.com</span>
              </a>
              ...
              <div className="flex items-center gap-3 text-gray-400">
                ...
                <span className="text-xs sm:text-sm">Calgary & Surrounding Areas, AB</span>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800">
          <div className="py-6 sm:py-8 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 max-w-7xl mx-auto">
              ...
              >
                <Link href="#privacy" className="text-gray-400 hover:text-[#339967] transition-colors">
                  Privacy Policy
                </Link>
                <Link href="#terms" className="text-gray-400 hover:text-[#339967] transition-colors">
                  Terms of Service
                </Link>
                <Link href="#accessibility" className="text-gray-400 hover:text-[#339967] transition-colors">
                  Accessibility
                </Link>
              </motion.div>
            </div>
